...
This project aims to create a productive environment while working on anything important.
![Focus App demo](https://github.com/Danielatonge/focusNow/blob/main/documentation/focusNow.gif)
...
- `src`: This folder is the main container of all the code inside your application.
  ...
  - `features`: Folder that contains all your application screens/features.
    - `Screen`: Each screen should be stored inside its folder and inside it a file for its code and a separate one for the styles and tests.
      ...
      - `Screen.styles.js`
      - `Screen.test.js`
  - `utils`: Folder to store constants used globally.
